 ...
 */
export function formatEnvVars(envVars: Record<string, string>): Array<{ key: string; value: string; masked?: boolean }> {
 ...
 */
export function formatPortMapping(port: { host: number; container: number; protocol?: string }): string {
 ...
 */
export function formatVolumeMapping(volume: { host: string; container: string; mode?: string }): string {
