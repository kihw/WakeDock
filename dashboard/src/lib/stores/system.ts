...
// Derived stores
export const systemStats = derived(
    { subscribe },
    ($system) => $system.overview?.system || null
);

export const dockerStatus = derived(
    { subscribe },
    ($system) => $system.overview?.docker || null
);

export const caddyStatus = derived(
    { subscribe },
    ($system) => $system.overview?.caddy || null
);
