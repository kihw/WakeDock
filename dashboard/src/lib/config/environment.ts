...
function loadConfig(): EnvironmentConfig {
    return {
        ...
        wsReconnectInterval: getNumberEnvVar('PUBLIC_WS_RECONNECT_INTERVAL', defaultConfig.wsReconnectInterval),
        wsMaxReconnectAttempts: getNumberEnvVar('PUBLIC_WS_MAX_RECONNECT_ATTEMPTS', defaultConfig.wsMaxReconnectAttempts),
        ...
        // Development
        isDevelopment: getBooleanEnvVar('NODE_ENV') !== false ? getEnvVar('NODE_ENV', 'development') === 'development' : defaultConfig.isDevelopment,
        ...
        features: {
            ...
            notifications: getBooleanEnvVar('PUBLIC_FEATURE_NOTIFICATIONS', defaultConfig.features.notifications),
            realTimeUpdates: getBooleanEnvVar('PUBLIC_FEATURE_REALTIME', defaultConfig.features.realTimeUpdates),
        },
    };
}
