  ...
  <div class="relative">
    <input
      ...
      class="block w-full {sizeClasses[
        size
      ]} border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100 disabled:cursor-not-allowed transition-colors duration-200"
      class:border-red-300={error}
      class:focus:border-red-500={error}
      class:focus:ring-red-500={error}
      class:border-green-300={showValidation && value && !error}
      class:focus:border-green-500={showValidation && value && !error}
      class:focus:ring-green-500={showValidation && value && !error}
