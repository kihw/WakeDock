...
<script lang="ts">
  ...
  export let variant: 'primary' | 'secondary' | 'danger' | 'success' | 'warning' | 'ghost' =
    'primary';
  ...
  const variantClasses = {
    ...
    danger:
      'text-white bg-red-600 hover:bg-red-700 focus:ring-red-500 border-transparent focus:ring-2 focus:ring-offset-2',
    success:
    ...
    ghost:
      'text-gray-500 bg-transparent hover:text-gray-700 hover:bg-gray-100 focus:ring-gray-500 border-transparent focus:ring-2 focus:ring-offset-2',
  };
