        ...
        <div class="service-details">
            <div class="detail-grid">
                ...
                <div class="detail-item">
                    ...
                    <span class="detail-value truncate" title={service.docker_compose || service.docker_image || "N/A"}>
                    ...
                    <div class="resource-metric">
                        <div class="metric-header">
                            ...
                            <div class="metric-info">
                                ...
                                <span class="metric-value {getResourceStatus(service.resource_usage.cpu_percent).color}">
                    ...
                    <div class="resource-metric">
                        <div class="metric-header">
                            ...
                            <div class="metric-info">
                                ...
                                <span class="metric-value {getResourceStatus(service.resource_usage.memory_percent).color}">
