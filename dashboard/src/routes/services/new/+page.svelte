        ...
        <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Basic configuration for your Docker service
                    </p>
                </div>
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <p class="mt-2 text-sm text-gray-500">
                                A unique name for your service. Used for
                        ...
                        <div class="col-span-6">
                            ...
                            />
                            <p class="mt-2 text-sm text-gray-500">
                                The Docker image to use for this service (e.g.,
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <p class="mt-2 text-sm text-gray-500">
                                When the container should be automatically
                                restarted.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6">
                            ...
                            <p class="mt-2 text-sm text-gray-500">
                                ...
                                (host:container:protocol). Protocol is optional
                                (default: tcp).
                            </p>
                        </div>
                        ...
                        <div class="col-span-6">
                            ...
                            />
                            <p class="mt-2 text-sm text-gray-500">
                                Comma-separated volume mounts
                                (host:container:mode). Mode is optional
                                (default: rw).
                            </p>
                        </div>
                    </div>
        ...
        <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Set environment variables and Docker labels
                    </p>
                </div>
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6">
                            ...
                            />
                            <p class="mt-2 text-sm text-gray-500">
                                Comma-separated Docker labels (key=value).
                            </p>
                        </div>
                    </div>
                </div>
