                ...
                <nav class="-mb-px flex">
                    {#each tabs as tab}
                        <button
                            ...
                            class="py-4 px-6 text-sm font-medium border-b-2 {activeTab ===
                            tab.id
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea
                                    bind:value={
                                        settings.general.app_description
                                    }
                                    rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                ></textarea>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-700"
                                    >Default Restart Policy</label
                                >
                                <select
                                    bind:value={
                                        settings.docker.default_restart_policy
                                    }
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                >
                            ...
                            <div>
                                ...
                                <select
                                    bind:value={
                                        settings.docker.image_pull_policy
                                    }
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                >
                                    <option value="always">Always</option>
                                    <option value="if-not-present"
                                        >If Not Present</option
                                    >
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="flex items-center">
                                <input
                                    type="checkbox"
                                    bind:checked={
                                        settings.caddy.admin_api_enabled
                                    }
                                    class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                                />
                                <label class="ml-2 block text-sm text-gray-900"
                                    >Enable Admin API</label
                                >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="flex items-center">
                                ...
                                />
                                <label class="ml-2 block text-sm text-gray-900"
                                    >Require Strong Passwords</label
                                >
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    type="number"
                                    bind:value={
                                        settings.logging.log_retention_days
                                    }
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                />
                            </div>
                            ...
                            <div class="flex items-center">
                                <input
                                    type="checkbox"
                                    bind:checked={
                                        settings.logging.structured_logging
                                    }
                                    class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                                />
                                <label class="ml-2 block text-sm text-gray-900"
                                    >Structured Logging (JSON)</label
                                >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="flex items-center">
                                ...
                                />
                                <label class="ml-2 block text-sm text-gray-900"
                                    >Enable Metrics Collection</label
                                >
                            </div>
                        </div>
                    </div>
